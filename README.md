...
* [Course slides (PDF)](https://github.com/sib-swiss/CAS-UNIL-intro-to-git/raw/main/slides_intro_to_git.pdf)
* [Exercise instructions](exercise_instructions.md)
* [Exercise material (.zip)](https://github.com/sib-swiss/CAS-UNIL-intro-to-git/raw/main/exercises.zip)
...
* In particular, make sure to communicate your
...
> **✨ Note:** this course focuses exclusively on using Git via
> **command line**, but this knowledge is easily transferable to any GUI
...
* **Finish exercises 1 and 3**, including the Additional Task sections (~1h).
* **Exercises 2 and 4**, including the Additional Task sections (~3h).
